...
delay:
	PUSH	$s0
	PUSH	$ra
	addi	$s0, $zero,1000	        # i = 0
	addi	$t1,$zero,30000   	# (intitaly was t1=4711)
...
done2:	
 ...
 time2string:
 	...
 	add	$s0,$zero,$a0		# contains the adress of string (timstr)
 	add	$s1,$zero,$a1		# contains the time-info(0x5957)
